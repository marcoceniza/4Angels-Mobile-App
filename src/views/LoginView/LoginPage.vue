        ...
        <ion-content fullscreen="true">
            <div class="form-container">
                ...
                <div class="form-input">
                    ...
                    <div class="btn_wrap">
                        <a href="javascript:;" @click="setOpen2(true)">Forgot password</a>
                        <a href="javascript:;" @click="$router.push('/loginadmin')">Login as Admin</a>
                    </div>
                </div>
            ...
            <ion-modal :is-open="isOpen2">
                ...
                <ion-content class="ion-padding resetPass">
                    ...
                    <ion-list>
                        <ion-item lines="none">
                            <ion-label>
                                <ion-input v-model="resetField" :clear-input="true" placeholder="Email"></ion-input>
                            </ion-label>
                        </ion-item>
                    </ion-list>
                    <ion-button @click="resetPass" color="danger" class="ion-margin-top btn_reset" expand="block" size="large" :disabled="formLoading">
                        <span v-if="!formLoading2" >Send</span>
...
export default defineComponent({
    ...
    methods: {
        resetPass() {
            ...
            axios.post('http://4angelshc.com/mobile/email/forgotpassword',null,{email: this.resetField}).then(res => {
